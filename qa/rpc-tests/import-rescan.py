...
import RPC call and node 0 sends ANZU to it. Then other nodes import the
...
In the second part of the test, node 0 sends more ANZU to each address, and the
...
class ImportRescanTest(AnzucoinTestFramework):
    def __init__(self):
        super().__init__()
