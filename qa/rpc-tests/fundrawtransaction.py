...
class RawTransactionsTest(AnzucoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid anzucoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid anzucoin address" in e.error['message'])
