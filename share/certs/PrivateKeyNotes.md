...
unlocked to sign the Anzucoin-Qt.app bundle.
...
allowing somebody to distribute a Anzucoin-Qt.app or anzucoin-qt-setup.exe with a valid
...
that the anzucoin-qt.exe file inside the installer had not been tampered with.
