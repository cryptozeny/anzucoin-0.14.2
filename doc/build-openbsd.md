...
ANZUCOIN_ROOT=$(pwd)
BOOST_PREFIX="${ANZUCOIN_ROOT}/boost"
...
at least with gcc 4.9.3 (see issue https://github.com/anzucoin/anzucoin/issues/6658).
...
with many 'local symbol discarded' errors:
    ...
    local symbol 150: discarded in section `.text._ZN10tinyformat6detail14FormatIterator6finishEv' from libanzucoin_util.a(libanzucoin_util_a-random.o)
    local symbol 151: discarded in section `.text._ZN10tinyformat6detail14FormatIterator21streamStateFromFormatERSoRjPKcii' from libanzucoin_util.a(libanzucoin_util_a-random.o)
    local symbol 152: discarded in section `.text._ZN10tinyformat6detail12convertToIntIA13_cLb0EE6invokeERA13_Kc' from libanzucoin_util.a(libanzucoin_util_a-random.o)
