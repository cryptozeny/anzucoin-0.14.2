...
This document provides guidelines for internationalization of the Anzucoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `anzucoin_en.ts` remains unchanged.
