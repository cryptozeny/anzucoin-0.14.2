Anzucoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/anzucoin/files/Anzucoin/anzucoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Anzucoin
...
New/changed settings (command-line or anzucoin.conf file)
--------------------------------------------------------
