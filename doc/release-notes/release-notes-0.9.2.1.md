Anzucoin Core version 0.9.2.1 is now available from:

  https://anzucoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ANZU to 0.01 ANZU
...
- Fix "Start anzucoin on system login"
