Anzucoin Core version 0.10.4 is now available from:

  <https://anzucoin.org/bin/anzucoin-core-0.10.4/>
...
- #6953 `43c2789` Split anzucoin-tx into its own package
- #6953 `dfe0d4d` Include anzucoin-tx binary on Debian/Ubuntu
