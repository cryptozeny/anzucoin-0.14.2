Anzucoin Core version 0.9.4 is now available from:

  https://anzucoin.org/bin/0.9.4/
...
this update is incompatible with the Anzucoin system and could lead to consensus
forks.

Anzucoin Core released binaries from https://anzucoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~anzucoin/+archive/ubuntu/anzucoin
- A third-party or self-compiled Anzucoin Core

upgrade to Anzucoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
