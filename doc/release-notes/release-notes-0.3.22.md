Download URL: https://sourceforge.net/projects/anzucoin/files/Anzucoin/anzucoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ANZU fee schedule (users still pay 0.01 ANZU per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #anzucoin00 - #anzucoin99
