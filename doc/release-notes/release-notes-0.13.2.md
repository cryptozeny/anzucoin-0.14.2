Anzucoin Core version 0.13.2 is now available from:
  ...
  <https://anzucoin.org/bin/anzucoin-core-0.13.2/>
...
- #8908 `4a974b2` Update anzucoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow anzucoin-tx to create v2 transactions (ANZUdrak)
