Anzucoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/anzucoin/files/Anzucoin/anzucoin-0.5.4/
...
http://gitorious.org/anzucoin/anzucoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Anzucoin-Qt notifications under Growl 1.3.
Increase required age of Anzucoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAnzucoin properly when installing Anzucoin-Qt over it. (Windows)
