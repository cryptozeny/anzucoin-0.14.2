Anzucoin Core version 0.10.3 is now available from:

  <https://anzucoin.org/bin/anzucoin-core-0.10.3/>
...
(see https://github.com/anzucoin/anzucoin/pull/6793, as well as the 0.11.0
