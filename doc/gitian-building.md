...
- [Building Bitcoin Core](#building-anzucoin-core)
...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-anzucoin-host/README.md).
...
Output from `gbuild` will look something like
    ...
    From https://github.com/anzucoin/anzucoin
...
For example:
```bash
URL=https://github.com/laanwj/anzucoin.git
...
[anzucoin-core/gitian.sigs](https://github.com/anzucoin-core/gitian.sigs/) repository, or if that's not possible create a pull
