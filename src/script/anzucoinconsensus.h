...
#ifndef ANZUCOIN_ANZUCOINCONSENSUS_H
#define ANZUCOIN_ANZUCOINCONSENSUS_H

#include <stdint.h>

#if defined(BUILD_ANZUCOIN_INTERNAL) && defined(HAVE_CONFIG_H)
#include "config/anzucoin-config.h"
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBANZUCOINCONSENSUS)
...
#define ANZUCOINCONSENSUS_API_VER 1
...
#endif // ANZUCOIN_ANZUCOINCONSENSUS_H
