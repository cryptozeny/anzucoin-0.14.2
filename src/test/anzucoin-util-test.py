...
# Copyright 2016 The Anzucoin Core developers
...
help_text="""Test framework for anzucoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/anzucoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "anzucoin-util-test.json", buildenv)
