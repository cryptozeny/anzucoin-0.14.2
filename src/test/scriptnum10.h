...
#ifndef ANZUCOIN_TEST_SCRIPTNUM10_H
#define ANZUCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Anzucoin Core 0.10.0, for cross-comparison.
 */
public:
