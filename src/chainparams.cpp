...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 10; // 10 sec. block time
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 1916; // 95% of 2016
        consensus.nMinerConfirmationWindow = 2016; // nPowTargetTimespan / nPowTargetSpacing // 2016 blocks
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,83); // Main 83 = a (small)
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x000000009c0bc725a8c3184f17d80e0658ef46213c828bc333e704bf3a59dfee")) //genesisBlock
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,23); //Test 111 to 23(A)
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("00000000f692ed6baa61f24df937fd171d4e3bc783fb858d6d05195f1efbcf3d")), //TESTNET
        };
...
public:
    CRegTestParams() {
        ...
        checkpointData = (CCheckpointData){
            ...
            ( 0, uint256S("0aa53739d9a0e0afb7a1a82b0b37abbfbfc51f65b5a9bd23a83b699b9e4c33d7"))
        };
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,23); //Regtest 111 to 23(A)
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
