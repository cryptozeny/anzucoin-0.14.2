...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Anzucoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Anzucoin
    // Mac: ~/Library/Application Support/Anzucoin
    // Unix: ~/.anzucoin
#ifdef WIN32
    // Windows
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Check for untranslated substitution to make sure Anzucoin Core copyright is not removed by accident
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Anzucoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Anzucoin Core developers";
    }
