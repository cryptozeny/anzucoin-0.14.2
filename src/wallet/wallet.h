...
#ifndef ANZUCOIN_WALLET_WALLET_H
#define ANZUCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this anzucoin node, and set to 0 for transactions that were created
...
#endif // ANZUCOIN_WALLET_WALLET_H
