...
{
    return QCoreApplication::translate("anzucoin-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. anzucoin_de.qm (shortcut "de" needs to be defined in anzucoin.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. anzucoin_de_DE.qm (shortcut "de_DE" needs to be defined in anzucoin.qrc)
...
void AnzucoinApplication::initializeResult(int retval)
{
    ...
    if(retval)
    {
        ...
        // anzucoin: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    /// 6. Determine availability of data directory and parse anzucoin.conf
    ...
    // anzucoin: links repeatedly have their payment requests routed to this process:
