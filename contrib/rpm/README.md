...
[Bitcoin git repository](https://github.com/anzucoin/anzucoin) but are not part of
...
in the anzucoin git repository. At present only an SVG version of the Bitcoin
icon is used.
